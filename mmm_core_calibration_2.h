...
LOG("\nAvg prop. cons. wages is %f.",v[20]);
LOG("\nAvg prop. cons. profits is %f.",v[21]);
LOG("\nAvg tax wages is %f.",v[23]);
LOG("\nAvg tax profits is %f.",v[22]);
LOG("\nAvg prop. imp. wages is %f.",v[24]);
LOG("\nAvg prop. imp. profits is %f.",v[25]);
...
v[90]=V("C_kappa");									//C sector real capital demand
v[91]=V("K_kappa");									//K sector real capital demand
v[92]=V("I_kappa");									//I sector real capital demand

v[93]=V("C_gov");
v[94]=V("K_gov");
v[95]=V("I_gov");
v[96]=1-v[93]-v[94]-v[95];
...
v[120]=(v[100]*v[55]+v[95]*v[111]+v[77]*v[114])/v[100];											//I sector input tech coefficient

v[121]=(v[94]*v[109]+v[76]*v[112])/v[102];														//C sector effective capital demand propensity
v[122]=(v[94]*v[110]+v[76]*v[113])/v[102];														//K sector effective capital demand propensity
v[123]=(v[94]*v[111]+v[76]*v[114])/v[102];														//I sector effective capital demand propensity

v[124]=v[22]*v[102]/(1-v[23]*v[96]);										//t*a
v[125]=v[25]*v[102]+v[24]*v[96]*v[124];										//m*a
v[126]=(v[20]*v[96]*v[124]+v[21]*v[102]+v[93]*v[124]+v[75]*v[125])/v[101];	//c*a
v[127]=1-(v[76]*v[125]/v[102])+(v[94]*v[124]/v[102]);						//k*a
v[128]=(v[77]*v[125]+v[95]*v[124])/v[100];									//i*a

v[129]=v[90]+v[91]+v[92];													//KA

v[130]=v[116]/(1-v[115]);													//c'k
v[131]=v[117]/(1-v[115]);													//c'i
v[132]=v[126]/(1-v[115]);													//c'a
v[133]=v[7]/(1-v[115]);														//ca'

v[134]=v[121]/(1-v[122]);													//k'c
v[135]=v[123]/(1-v[122]);													//k'i
v[136]=v[127]/(1-v[122]);													//k'a

v[137]=v[118]/(1-v[120]);													//i'c
v[138]=v[119]/(1-v[120]);													//i'k
v[139]=v[128]/(1-v[120]);													//i'a

v[200]=(v[130]+v[131]*v[138])/(1-v[131]*v[137]);							//c''k
v[201]=(v[132]+v[131]*v[139])/(1-v[131]*v[137]);							//c''a
v[202]=v[133]/(1-v[131]*v[137]);											//ca''

v[203]=(v[134]+v[135]*v[137])/(1-v[135]*v[138]);							//k''c
v[204]=(v[136]-v[135]*v[139])/(1-v[135]*v[138]);							//k''a

v[141]=(v[129]*(v[204]*v[200]-v[201])+v[202])/(1-v[203]*v[200]);			//initial consumption demand
v[142]=v[141]*v[203]+v[129]*v[204];											//initial capital demand
v[143]=v[141]*v[137]+v[142]*v[138]-v[129]*v[139];							//initial input demand

if((v[106]*v[141])!=0)
v[62]=(v[106]*v[141]-v[102]*v[90])/(v[106]*v[141]);
else
v[62]=1;
if((v[107]*v[142])!=0)
v[63]=(v[107]*v[142]-v[102]*v[91])/(v[107]*v[142]);
else
v[63]=1;
if((v[108]*v[143])!=0)
v[64]=(v[108]*v[143]-v[102]*v[92])/(v[108]*v[143]);
else
v[64]=1;
...
LOG("\nC sector intial demand is %f.",v[141]);
LOG("\nK sector intial demand is %f.",v[142]);   
LOG("\nI sector intial demand is %f.",v[143]);   
LOG("\nTotal Taxes is %f.",v[144]);   
LOG("\nIndirect Taxes is %f.",v[145]);   
LOG("\nTotal Wages is %f.",v[146]);   
LOG("\nTotal Profits is %f.",v[147]);   
LOG("\nDistributed Profits is %f.",v[148]);   
LOG("\nTotal Imports is %f.",v[149]);   
LOG("\nGDP is %f.",v[150]);   
LOG("\nC sector distribution rate is %f.",v[62]);   
LOG("\nK sector distribution rate is %f.",v[63]);   
LOG("\nI sector distribution rate is %f.",v[64]);        
...
CYCLE(cur, "SECTORS")
{
	...
	WRITES(cur, "sector_profits_distribution_rate", v[62]);
	...
	WRITES(cur, "sector_profits_distribution_rate", v[63]);
	...
	WRITES(cur, "sector_profits_distribution_rate",v[64]);
