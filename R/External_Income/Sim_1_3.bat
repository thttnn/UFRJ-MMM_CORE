...
if "%~1"=="" (set LSD_EXEC="C:\Lsd-7.2-stable\Work\MMM_CORE\lsdNW.exe") else (set LSD_EXEC="%~1")
if "%~2"=="" (set LSD_CONFIG_PATH="C:\Lsd-7.2-stable\Work\MMM_CORE\R\External_Income") else (set LSD_CONFIG_PATH="%~2")
