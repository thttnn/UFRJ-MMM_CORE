...
LOG("\nC initial demand is %f.",v[41]);       
LOG("\nK initial demand is %f.",v[42]);      
LOG("\nI initial demand is %f.",v[43]);      
LOG("\nTotal Taxes is %f.",v[44]);      
LOG("\nIndirect Taxes is %f.",v[45]);       
LOG("\nTotal Wages is %f.",v[46]);       
LOG("\nTotal Porfits is %f.",v[47]);     
LOG("\nDistributed Profits is %f.",v[48]);      
LOG("\nTotal Imports is %f.",v[49]);     
LOG("\nGDP is %f.",v[50]);   
LOG("\nPrice Index is %f.",v[19]);  
